...
const Register = () => {
  ...
  return (
    <div className="mt-6 w-full px-4 md:mx-auto md:w-1/3 2xl:w-1/4">
      <form className="shadow-[0px_4px_15px_rgba(255,69,58,0.15)] rounded-md p-3" onSubmit={handleSubmit(onSubmit)}>
        <Link href={"/"}>
          <Image
        ...
        <button
          disabled={isLoading}
          type="submit"
          className="bg-primary py-3 mt-3 rounded-md text-white w-full cursor-pointer"
        >
          {isLoading ? (
