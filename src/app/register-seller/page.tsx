    ...
    return (
        ...
        >
            ...
            <form className="bg-white rounded-md p-4 w-1/3 mx-auto" onSubmit={handleSubmit(onSubmit)}>
                ...
                <h1 className="text-2xl font-medium py-5">Register Your Seller Account</h1>
                <div>
                ...
                <button className="bg-green-500 py-2 rounded-md mt-3 text-white w-full"  type="submit">Create Account</button>
