    ...
    return (
        ...
        >
            ...
            <form className="bg-white rounded-md p-4 w-1/3 mx-auto" onSubmit={handleSubmit(onSubmit)}>
                ...
                <input className="bg-green-500 py-2 rounded-md mt-3 text-white w-full cursor-pointer" type="submit" />
                <h1 className="pt-2 text-center text-gray-600">Do not have an account <Link className="text-blue-500" href={"/register"}>Register</Link></h1>
